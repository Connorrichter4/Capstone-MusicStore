...
--insert into album values(1,'THE ALBUM',9.99,'2020-02-10','img/BLACKPINK-_The_Album.png',99,'NEW',1);
insert into album values(1, '2020-02-10', 'img/BLACKPINK-_The_Album.png', 99, 'THE ALBUM', 9.99, 'NEW', 1);
--insert into album values(2,'THE NEXT ALBUM',13.99,'2021-02-01','img/photo.png',15,'NEW',1);
--insert into album values(3,'THE FINAL ALBUM',19.99,'2021-05-05','img/final.png',3,'USED',2);
